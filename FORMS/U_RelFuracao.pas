...
procedure Tfrm_RelFuracao.bt_PesquisaClick(Sender: TObject);
begin
  pesq_peca;
end;

procedure Tfrm_RelFuracao.cb_chave_pesquisaChange(Sender: TObject);
begin
...
procedure Tfrm_RelFuracao.ed_nomeKeyPress(Sender: TObject; var Key: Char);
begin
if key=#13 then
    begin
      pesq_Peca;
...
procedure Tfrm_RelFuracao.FormShow(Sender: TObject);
begin
ed_nome.Visible := False;
end;
