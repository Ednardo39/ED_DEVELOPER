   ...
   2:
    ...
    3:
      begin // pesquisa todas as peças trabalhadas
        ...
        lbl_EdtInicio.Visible := false;
        lbl_EdtFinal.Visible := false;
        lb_nome.Caption := 'Peças cortadas';
      end;
...
procedure Tfrm_RelCorte.DBGrid1DrawColumnCell(Sender: TObject;
...
begin
 ...
 case cb_chave_pesquisa.ItemIndex of
   ...
   3:begin// pesquisa todas as peças CORTADAS
...
Statusbar1.Panels[3].Text:='Relatório de CORTE:';
end;

procedure Tfrm_RelCorte.bt_ImprimirClick(Sender: TObject);
var
  caminho: string;
begin
    // ABRE RELATÓRIO
